          ...
          {quickActions.map((action) => {
            ...
            return (
              ...
              >
                ...
                <span className="ml-auto flex h-4 w-4 shrink-0 items-center justify-center rounded-full border border-white/10 text-slate-400 transition-all duration-200 group-hover:border-cyan-400/50 group-hover:bg-cyan-500/20 group-hover:text-cyan-300">
                  <ArrowRight size={10} />
                </span>
              </button>
            )
