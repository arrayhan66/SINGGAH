...
const actions = [
  { label: "Tambah Karya", icon: Plus, to: "/admin/karya/tambah", color: "text-cyan-400", glow: "shadow-cyan-500/20" },
  { label: "Tulis Berita", icon: FileText, to: "/admin/berita/tambah", color: "text-pink-400", glow: "shadow-pink-500/20" },
  { label: "Tambah User", icon: UserPlus, to: "/admin/pengguna/tambah", color: "text-emerald-400", glow: "shadow-emerald-500/20" },
