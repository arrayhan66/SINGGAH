            ...
            <div className="relative">
              ...
              {featuredMenuOpen && (
                <>
                  ...
                  />
                  <div className="card-featured-menu absolute right-0 z-20 mt-1.5 w-48 overflow-hidden rounded-xl border border-blue-500/30 bg-blue-950 py-1.5 shadow-2xl shadow-black/60 backdrop-blur-xl">
          ...
          {project.status === "pending" ? (
            <>
              <button
                type="button"
                onClick={() => onViewDetail(project)}
                className="flex flex-1 cursor-pointer items-center justify-center gap-1.5 rounded-lg bg-gradient-to-r from-blue-600 via-cyan-500 to-blue-600 bg-[length:200%_100%] px-3 py-2 text-xs font-semibold text-white shadow-lg shadow-cyan-500/25 transition-all duration-500 hover:bg-[position:100%_0]"
              >
            ...
            <button
              type="button"
              onClick={() => onViewDetail(project)}
              className="flex w-full cursor-pointer items-center justify-center gap-1.5 rounded-lg bg-gradient-to-r from-blue-600 via-cyan-500 to-blue-600 bg-[length:200%_100%] px-3 py-2 text-xs font-semibold text-white shadow-lg shadow-cyan-500/25 transition-all duration-500 hover:bg-[position:100%_0]"
            >
              <Eye className="h-3.5 w-3.5" />
              Lihat Detail
            </button>
