...
function LoginBranding({ backTo = "/" }) {
  return (
    <div className="relative hidden w-1/2 flex-col justify-between overflow-hidden bg-slate-950 p-10 lg:p-14 2xl:p-16 lg:flex border-r border-cyan-500/20">
      ...
      {/* TOP HEADER SECTION: Tombol Kembali & Badge Poliban */}
      <div className="relative z-20 flex items-center justify-between w-full">
        ...
        {/* Poliban Mini Badge (Diubah dari xl:flex ke lg:flex agar muncul bersamaan saat layout desktop aktif) */}
      ...
      {/* CENTER HERO CONTENT: Card Glassmorphism yang Padat & Berisi */}
