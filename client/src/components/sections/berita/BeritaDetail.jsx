...
function BeritaDetail() {
  ...
  if (!item) {
    return (
      <section className="relative min-h-screen bg-brand-navy pt-[calc(var(--navbar-h)-8px)] pb-16">
  ...
  return (
    <section className="relative overflow-hidden bg-brand-navy min-h-screen pt-[calc(var(--navbar-h)+20px)] pb-16 sm:pb-20 lg:pb-24">
      <DustBackground />
          ...
          <div className="p-4 min-[350px]:p-5 sm:p-8 lg:p-10 bg-brand-navy border-b border-slate-800/80">
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 pb-0">
              ...
              <button
                ...
                className="group inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm text-slate-300 hover:border-cyan-400/40 hover:bg-cyan-400/10 hover:text-cyan-300 transition-all duration-300 shadow-sm"
              >
                <Share2
                  size={13}
