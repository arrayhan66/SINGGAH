      ...
      {!isDosen && (
        <div className="relative min-w-0 shrink-0" ref={dropdownRef}>
          <button
            ...
            className="flex w-full sm:w-auto items-center justify-between sm:justify-start gap-2.5 rounded-xl border-2 border-white/60 bg-white/90 px-4 py-2.5 text-sm font-medium text-slate-800 backdrop-blur-md shadow-xl transition-all duration-300 hover:shadow-2xl focus-within:-translate-y-1 focus-within:border-cyan-400 focus-within:bg-white focus-within:shadow-cyan-400/30 sm:rounded-2xl sm:px-5 sm:py-3 md:py-3.5 lg:py-4 3xl:gap-3 3xl:px-6 3xl:py-4.5 4xl:py-5"
          >
