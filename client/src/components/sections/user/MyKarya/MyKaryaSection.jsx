...
import { MyKaryaPageSkeleton, MyKaryaFilterSkeleton } from "../../../ui/PageSkeletons"
...
function MyKaryaSection() {
  ...
  function handleConfirmDelete() {
    ...
    api.delete(`/projects/${deletedId}`)
      .then(() => {
        setKarya((prev) => prev.filter((k) => k.id !== deletedId))
  ...
  return (
    <>
      <section className="hero relative bg-brand-dark px-4 pt-[calc(var(--navbar-h)+24px)] pb-10 sm:px-6 sm:pt-[calc(var(--navbar-h)+32px)] sm:pb-12 md:px-8 lg:px-12 2xl:px-16 2xl:pb-14 3xl:px-20 3xl:pb-16 4xl:px-24 4xl:pb-20">
        ...
        <div className="relative z-10 mx-auto max-w-7xl 2xl:max-w-[1440px] 3xl:max-w-[1800px] 4xl:max-w-[2200px]">
          ...
          <div className="mt-8 sm:mt-10 md:mt-12 2xl:mt-14 3xl:mt-16 4xl:mt-20">
            {loading ? (
          ...
          {loading ? (
            ...
            <>
              {filteredData.length === 0 ? (
                <div className="mt-4 flex flex-col items-center justify-center rounded-2xl border border-dashed border-slate-700/60 bg-slate-800/20 py-16 sm:mt-6 sm:py-24 2xl:mt-8 2xl:py-32 3xl:mt-10 3xl:py-40 4xl:mt-12 4xl:py-48">
                ...
                <div className="mt-4 grid gap-8 md:grid-cols-2 lg:grid-cols-3 2xl:mt-6 2xl:gap-10 3xl:mt-8 3xl:gap-12 4xl:mt-10 4xl:gap-14">
                  {visibleData.map((karyaItem) => (
                    <MyKaryaCard
                      ...
                      isDosen={isDosen}
                      isDeleting={deletingId === karyaItem.id}
                    />
                  ))}
                </div>
              )}
