...
const heroSize =
  "h-16 w-16 aspect-square shrink-0 min-[350px]:h-20 min-[350px]:w-20 md:h-28 md:w-28 lg:h-32 lg:w-32 2xl:h-36 2xl:w-36"
...
function ProfileHero({ isAdmin = false }) {
  ...
  if (isAdmin) {
    return (
      <AdminHeroBackground fullWidth className="hero">
  ...
  return (
    <AdminHeroBackground className="hero px-4 pt-28 pb-6 md:px-12 md:pt-32 md:pb-8 lg:px-16 lg:pb-10 2xl:px-20 2xl:pt-36 2xl:pb-12">
      <div className="mx-auto flex max-w-5xl flex-col items-center text-center lg:max-w-6xl 2xl:max-w-7xl">
        {content}
      </div>
    </AdminHeroBackground>
