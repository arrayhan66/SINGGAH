...
function ProjectDeletedModal({
  ...
  return (
    <PopupToast show={isOpen} variant="success" onClose={onClose} duration={AUTO_REDIRECT_SECONDS * 1000}>
      <div className="px-4 py-3.5">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 flex-1">
            <h3 className="pt-1 text-sm font-semibold text-white">Karya Berhasil Dihapus</h3>
            <p className="mt-0.5 text-xs text-slate-400 min-w-0 break-words line-clamp-2">"{karyaTitle}"</p>
          </div>
        </div>
        <div className="mt-3 rounded-lg border border-amber-500/30 bg-amber-500/10 px-3 py-2">
          <p className="text-[11px] font-medium text-amber-300">
            Karya dihapus permanen beserta semua data terkait dan tidak bisa dikembalikan.
          </p>
        </div>
        <div className="mt-3 flex gap-2">
          ...
          >
            Kembali ke Karya <ArrowRight className="h-3.5 w-3.5" />
          </button>
        </div>
...
export default ProjectDeletedModal