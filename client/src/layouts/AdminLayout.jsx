...
function AdminLayout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-brand-dark">
      ...
      <main className={`min-h-screen pt-16 transition-all duration-300 ${collapsed ? "ml-0 lg:ml-20" : "ml-0 lg:ml-64"} min-[260px]:ml-0`}>
      ...
      <div className={`transition-all duration-300 ${collapsed ? "ml-0 lg:ml-20" : "ml-0 lg:ml-64"} min-[260px]:ml-0 w-full`}>
        <Footer />
      </div>
    </div>
  )
