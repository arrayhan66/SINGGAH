...
function MuseumBarrier() {
  ...
  return (
    <group>
      {posts.map((p, i) => (
        <Post key={i} position={[p.x, 0, p.z]} low={low} />
      ))}
      {posts.map((p, i) => {
